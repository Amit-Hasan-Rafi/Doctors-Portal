...
function Services() {
    ...
    return (
        <div className='mt-20'>
            ...
            <div className="hero mt-20 text-center lg:text-left">
                <div className="hero-content flex-col lg:flex-row">
                    <img src="https://i.ibb.co/4ms5YR5/treatment.png" className="w-fit m-0 lg:mr-11 lg:w-80 rounded-lg shadow-2xl" />
                    <div>
